const cases = [
  {
    id: "accountant-suite", number: "01", eyebrow: "Platform launch · Intuit", title: "Launching Intuit Accountant Suite as a measurable growth engine",
  ...
  {
    id: "portfolio-scale", number: "02", eyebrow: "Cross-org operating model · Intuit", title: "Turning Mid-Market demand chaos into a repeatable system",
  ...
  {
    id: "ai-adoption", number: "03", eyebrow: "AI adoption · Intuit", title: "Building an AI-native operating culture—not a training campaign",
  ...
  {
    id: "enterprise-ai", number: "04", eyebrow: "0→1 enterprise bet · Intuit", title: "Translating AI + Human Intelligence strategy into execution",
  ...
  {
    id: "ma-integration", number: "05", eyebrow: "M&A integration · Chegg", title: "Converting acquisition strategy into realized value",
  ...
  {
    id: "enterprise-transformation", number: "06", eyebrow: "Enterprise transformation · PayPal", title: "Scaling faster, safer launches across a global platform",
...
export default function Home() {
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <div className="hero-metrics" id="impact"><a href="#portfolio-scale" aria-label="Read about the 125 million dollar portfolio"><strong>$125M+</strong><span>Portfolio led</span></a><a href="#portfolio-scale" aria-label="Read about the 400 engineers in scope"><strong>~400</strong><span>Engineers in scope</span></a><a href="#ai-adoption" aria-label="Read about leading 10 TPMs"><strong>10</strong><span>TPMs led</span></a><a href="#accountant-suite" aria-label="Read about 5,000 accountant signups"><strong>5,000+</strong><span>Accountant signups</span></a><a href="#ai-adoption" aria-label="Read about 100 PMO hours saved with AI"><strong>100+</strong><span>PMO hours saved with AI</span></a><a href="#career" aria-label="Explore more than 20 years of career experience"><strong>20+</strong><span>Years leading change</span></a></div>
    </section>
