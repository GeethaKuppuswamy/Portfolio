...
export default function Home() {
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <div className="hero-bottom"><p>Two decades connecting product vision, engineering execution, and operating systems to deliver measurable outcomes at scale.</p><div className="hero-actions"><a className="button primary" href="#work">Explore my work <span>↓</span></a></div></div>
